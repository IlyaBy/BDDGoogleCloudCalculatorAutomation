...
public class CalculatorPricingPage extends AbstractPage {
    ...
    private final By estimatedCost = By.xpath("//div[div[normalize-space()='Estimated cost']]//label[contains(text(),'$')]");
    ...
    public CalculatorPricingPage startEstimation() {
        logger.info("Initializing Compute Engine estimation form.");
    ...
    public String getCalculatorCost() {
